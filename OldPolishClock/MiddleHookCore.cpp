...
CDumpMiddleHooh::CDumpMiddleHooh()
{
	...
	hook4.X = -1.0f;
	hook4.ParseMesh( hook3.GetMesh() );
	hook4.CommitMesh( true, true );
	hook4.SaveMesh( L"middle_hook.x" );
}

void CDumpMiddleHooh::CHookAddTransform::OnParseTriangle( const VERTEXPLAIN & a, const VERTEXPLAIN & b, const VERTEXPLAIN & c )
{
...
void CDumpMiddleHooh::CHookAddDeph::OnParseTriangle( const VERTEXPLAIN & a, const VERTEXPLAIN & b, const VERTEXPLAIN & c )
{
	VERTEXPLAIN aNew( a ), bNew( b ), cNew( c );
...
void CDumpMiddleHooh::CHookAddFinalize::OnParseTriangle( const VERTEXPLAIN & a, const VERTEXPLAIN & b, const VERTEXPLAIN & c )
{
	VERTEXPLAIN aNew( a ), bNew( b ), cNew( c );
...
void CDumpMiddleHooh::CHookAddFinalize2::OnParseTriangle( const VERTEXPLAIN & a, const VERTEXPLAIN & b, const VERTEXPLAIN & c )
{
	VERTEXPLAIN aNew( a ), bNew( b ), cNew( c );
