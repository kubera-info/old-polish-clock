...
static CAutoPtr<CSystemLibrary>             s_hModD3D9;
...
static CAutoPtr<CSystemLibrary>             s_hModDXGI;
static LPCREATEDXGIFACTORY                  s_DynamicCreateDXGIFactory = NULL;
static CAutoPtr<CSystemLibrary>             s_hModD3D11;
...
static bool DXUT_EnsureD3D9APIs( void )
{
	...
	s_hModD3D9.Free();
	s_hModD3D9.Attach( new CSystemLibrary( L"d3d9.dll" ) );
    if( *s_hModD3D9 != NULL )
    {
        s_DynamicDirect3DCreate9 = (LPDIRECT3DCREATE9)s_hModD3D9->GetProcAddress( "Direct3DCreate9" );
        s_DynamicD3DPERF_BeginEvent = (LPD3DPERF_BEGINEVENT)s_hModD3D9->GetProcAddress( "D3DPERF_BeginEvent" );
        s_DynamicD3DPERF_EndEvent = (LPD3DPERF_ENDEVENT)s_hModD3D9->GetProcAddress( "D3DPERF_EndEvent" );
        s_DynamicD3DPERF_SetMarker = (LPD3DPERF_SETMARKER)s_hModD3D9->GetProcAddress( "D3DPERF_SetMarker" );
        s_DynamicD3DPERF_SetRegion = (LPD3DPERF_SETREGION)s_hModD3D9->GetProcAddress( "D3DPERF_SetRegion" );
        s_DynamicD3DPERF_QueryRepeatFrame = (LPD3DPERF_QUERYREPEATFRAME)s_hModD3D9->GetProcAddress( "D3DPERF_QueryRepeatFrame" );
        s_DynamicD3DPERF_SetOptions = (LPD3DPERF_SETOPTIONS)s_hModD3D9->GetProcAddress( "D3DPERF_SetOptions" );
        s_DynamicD3DPERF_GetStatus = (LPD3DPERF_GETSTATUS)s_hModD3D9->GetProcAddress( "D3DPERF_GetStatus" );
    }
...
bool DXUT_EnsureD3D11APIs( void )
{
	...
	s_hModD3D11.Free();
    s_hModD3D11.Attach( new CSystemLibrary( L"d3d11.dll" ) );
    if( *s_hModD3D11 != NULL )
    {
        s_DynamicD3D11CreateDevice = ( LPD3D11CREATEDEVICE )s_hModD3D11->GetProcAddress( "D3D11CreateDevice" );
    }

    if( !s_DynamicCreateDXGIFactory )
    {
		s_hModDXGI.Free();
        s_hModDXGI.Attach( new CSystemLibrary( L"dxgi.dll" ) );
        if( *s_hModDXGI )
        {
            s_DynamicCreateDXGIFactory = ( LPCREATEDXGIFACTORY )s_hModDXGI->GetProcAddress( "CreateDXGIFactory1" );
        }
